...
<button class="cerrarSesion"><a href="index.html"> Cerrar Sesión</a> </button>
                  ...
                  <!-- RD Navbar Nav-->
                   <ul class="rd-navbar-nav">
                    ...
                    <li class="active"><a href="quienes somos.php">Quienes Somos<span></span><span></span><span></span><span></span></a>
                    </li>
            ...
            <div class="cell-sm-9 cell-md-6">
                    ...
                    <article class="quote-boxed"><span></span><span></span><span></span><span></span>
                      ...
                      <ul class="quote-boxed__meta">
                        <li>
                          <div class="unit unit-horizontal unit-middle">
                            <div class="unit__left"><img class="quote-boxed__avatar" src="images/15.1.png" alt="" width="46" height="46"/>
                            </div>
